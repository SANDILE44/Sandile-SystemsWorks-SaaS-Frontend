...
$("log-shipments-output").textContent=data.shipments;
...
$("log-revenue-per-shipment").textContent=money(data.totalRevenue/data.shipments||0);
...
$("log-breakeven-shipments").textContent=data.breakEvenShipments;
